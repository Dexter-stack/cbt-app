...
$mail->Username = 'hello@droitware.com';                 // SMTP username
$mail->Password =   "Fruof1@droit";                     // SMTP password 'iufy btgw kfzh ndqs';
...
$mail->AddEmbeddedImage('dware.png','logoimg','dware.png');                            // Set email format to HTML
        ...
        <table role="presentation" style="width:602px;border-collapse:collapse;border:1px solid #cccccc;border-spacing:0;text-align:left;">
          <tr>
            <td align="center" style="padding:40px 0 30px 0;background:#70bbd9;">
              <img src="cid:logoimg" alt="" width="300" style="height:auto;display:block;" />
            </td>
          </tr>
          <tr>
...
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
